			...
			<div class="col-xl-8 col-lg-10 offset-xl-2 offset-lg-1">
				...
				<div class="card card-custom none" id="card">
					<form id="form" class="card-body">
						...
						<div class="form-group row">
							<label for="hidden" class="col-lg-4 col-sm-5 col-form-label text-secondary">Sembunyikan</label>
							<div class="col-lg-8 col-sm-7">
								<select class="custom-select" id="hidden" role="button">
									<option value="0">Tidak</option>
									<option value="1">Ya</option>
								</select>
								<div class="invalid-feedback" id="hidden-feedback"></div>
							</div>
						</div>
						<div class="row">
...
@section('script')
	...
	<script src="{{asset('api/upload-document.js')}}"></script>
@endsection
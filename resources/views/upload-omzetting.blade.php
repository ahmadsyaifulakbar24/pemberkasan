...
@section('title','Upload Omzetting')

@section('content')
	<div class="container">
		<div class="row">
			<div class="col-xl-8 col-lg-10 offset-xl-2 offset-lg-1">
				<h5 class="pb-2">Upload Omzetting</h5>
						...
						<div class="row">
							<div class="offset-lg-4 offset-md-5 col-lg-8 col-md-7 mt-3">
								<div class="form-group">
									...
									<button class="btn btn-block btn-primary px-3" id="submit">Upload Omzetting</button>
								</div>
							</div>
						</div>
					</form>
...
@section('script')
	...
	<script src="{{asset('api/upload-omzetting.js')}}"></script>
@endsection